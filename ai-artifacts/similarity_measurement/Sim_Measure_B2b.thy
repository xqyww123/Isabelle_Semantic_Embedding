...
fun galmuth :: "nat list => nat" where
  "galmuth [] = 0"
| "galmuth (x # xs) = (if x mod 2 = 0 & x < 100 then x + galmuth xs else galmuth xs)"
...
fun narquil :: "quilm => nat" where
  "narquil (Brint n) = (if n < 5 then 0 else 1)"
