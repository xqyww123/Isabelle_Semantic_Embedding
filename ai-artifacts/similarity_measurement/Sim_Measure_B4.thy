...
fun narquil :: "quilm => nat" where
  "narquil (Brint k) = (if k < 5 then 1 else 0)"
| "narquil (Glaive u v) = narquil u + narquil v"
...
locale dremnok =
  fixes zug :: "'a => 'a => 'a"
  assumes zug_law: "zug x (zug x y) = y"
begin
